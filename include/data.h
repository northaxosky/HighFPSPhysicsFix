...
namespace HFPF
{
	namespace AID
	{
		...
		// NG/AE values sourced from upstream/master:include/data.h. NG slot
		// mirrors AE per upstream's shared NG/AE DLL design.
		constexpr REL::ID FPS_Cap_Patch1                 { 133902, 2228907, 2228907 };
		constexpr REL::ID FullScreen_Patch1              { 1547437, 2227231, 2227231 };
		// AE has standalone MovRaxRcx AID; OG inlines it inside ResizeBuffers.
		constexpr REL::ID MovRaxRcx                      { 212827, 2276824, 2276824 };
		constexpr REL::ID ResizeTarget                   { 796949, 2276825, 2276825 };
		// AE has standalone CreateDXGIFactory AID; OG uses D3D11Create as the parent symbol.
		constexpr REL::ID CreateDXGIFactory              { 224250, 4492363, 4492363 };
		constexpr REL::ID FrameTimer                     { 922988, 4803789, 4803789 };
		constexpr REL::ID CreateWindowEx_a               { 193854, 2276814, 2276814 };
		constexpr REL::ID BlackLoadingScreens            { 991513, 2249217, 2249217 };
		constexpr REL::ID LoadingScreens                 { 132841, 2227631, 2227631 };
		constexpr REL::ID PostLoadInject                 { 1289136, 2248711, 2248711 };
		constexpr REL::ID PresentThread                  { 700869, 2276834, 2276834 };
		constexpr REL::ID Untie                          { 462873, 2267969, 2267969 };
		constexpr REL::ID ExtInt                         { 359440, 359440, 359440 };
		constexpr REL::ID FixStuttering1                 { 12890, 2277709, 2277709 };
		constexpr REL::ID FixStuttering2                 { 1395106, 2277710, 2277710 };
		constexpr REL::ID ObjectsTransfer                { 754666, 2255886, 2255886 };
		constexpr REL::ID FixWhiteScreen                 { 703643, 2258401, 2258401 };
		constexpr REL::ID FixWindSpeed1                  { 1469635, 2278751, 2278751 };
		constexpr REL::ID FixWindSpeed2                  { 1164603, 2277711, 2277711 };
		constexpr REL::ID FixRotationSpeed               { 457276, 2234879, 2234879 };
		constexpr REL::ID FixLockpickRotation            { 676000, 2249260, 2249260 };
		constexpr REL::ID FixWSRotationSpeed             { 1144472, 2195211, 2195211 };
		constexpr REL::ID FixRepeateRate                 { 618896, 2249218, 2249218 };
		// OG branch named this FixTriggerZoomSpeed (one trigger handles both); AE split into Left/Right.
		constexpr REL::ID FixLeftTriggerZoomSpeed        { 629736, 2249220, 2249220 };
		constexpr REL::ID FixLoadScreenRotationSpeed     { 22234, 2249233, 2249233 };
		constexpr REL::ID FixStuckAnim                   { 463133, 2302542, 2302542 };
		constexpr REL::ID FixMotionFeedback              { 1201084, 2196089, 2196089 };
		constexpr REL::ID FixSittingRotationX            { 533372, 2248271, 2248271 };
		constexpr REL::ID Upscale                        { 288964, 2276833, 2276833 };
		constexpr REL::ID ActorFade                      { 295466, 2214659, 2214659 };
		constexpr REL::ID PlayerFade                     { 202079, 2248393, 2248393 };
		constexpr REL::ID BudgetGame                     { 759508, 2251303, 2251303 };
		constexpr REL::ID BudgetUI                       { 1343068, 2251305, 2251305 };
		constexpr REL::ID Budget                         { 890788, 2251306, 2251306 };
		// OG branch names this Write_iLocationX (single AID for both X/Y axes).
		constexpr REL::ID Write_iLocation                { 719782, 8695006, 8695006 };
		...
		constexpr REL::ID LoadPluginINI_C                { 1266784, 2228907, 2228907 };
	}
